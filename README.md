...
Fork of [badlogic/gccli](https://github.com/badlogic/gccli). Two changes:

- `gccli accounts reauth [emails...] [--manual]` re-runs OAuth for the given accounts (all if none) and replaces the
...
- Irreversible actions (`delete`) print what they will do and block for human approval: Touch ID on the
